<template>
  <q-card class="q-pa-md"
    style="border-radius: 12px; box-shadow: 0 10px 64px rgba(0, 0, 0, 0.2), 0 6px 10px rgba(0, 0, 0, 0.14), 0 10px 3px -1px rgba(0, 0, 0, 0.12);">
    <div class="row items-center justify-between q-gutter-md">
      ...
      <div class="row items-center q-gutter-sm">
        ...
        <q-btn v-if="puedeMostrarFicha" unelevated dense :icon="isPPL ? 'visibility_off' : 'visibility'"
...
/**
* Componente de navegación especial que muestra:
* - Botón para regresar al sistema principal (SIPF).
* - Botón para mostrar/ocultar ficha PPL si está disponible.
* - Breadcrumbs con el título actual de la página.
*
* Se apoya en `provide/inject` para acceder al estado global:
* - `isPPL`: bandera para mostrar u ocultar la ficha.
* - `toggleFicha`: función para alternar visibilidad.
